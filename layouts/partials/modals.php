...
<div class="modal modal--sing-up" id="sing-up">
	<div class="modal__title">Записаться на услугу</div>

	<form method="POST" class="modal__form" name="Запись">
		<fieldset class="fieldset modal__fieldset modal__fieldset--fullname">
			<legend class="fieldset__legend">ФИО</legend>
			<input type="text" class="fieldset__input" name="client_name" required>
		</fieldset>
		...
		<input type="text" class="hidden js-service-input" name="client_service" value="">
		...
		<?php wp_nonce_field( 'Запись', 'modal-sing-up-nonce' ); ?>
	</form>
</div>
